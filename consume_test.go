...
var testRssFeedXML = RssFeedXml{
	...
	Channel: &RssFeed{
		...
		Description:    &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "This is a constantly updating lorem ipsum feed"},
		Language:       "",
		...
		Items: []*RssItem{
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Exercitation ut Lorem sint proident."},
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Ea est do quis fugiat exercitation."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Ipsum velit cillum ad laborum sit nulla exercitation consequat sint veniam culpa veniam voluptate incididunt."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Ullamco pariatur aliqua consequat ea veniam id qui incididunt laborum."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Velit proident aliquip aliquip anim mollit voluptate laboris voluptate et occaecat occaecat laboris ea nulla."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Do in quis mollit consequat id in minim laborum sint exercitation laborum elit officia."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Irure id sint ullamco Lorem magna consectetur officia adipisicing duis incididunt."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Sunt anim excepteur esse nisi commodo culpa laborum exercitation ad anim ex elit."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Excepteur aliquip fugiat ex labore nisi."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
			...
			},
			{
				...
				Description: &RssDescription{XMLName: xml.Name{Space: "", Local: "description"}, Description: "Id proident adipisicing proident pariatur aute pariatur pariatur dolor dolor in voluptate dolor."},
				Content:     (*RssContent)(nil),
				Author:      "",
				Category:    "",
				Comments:    "",
